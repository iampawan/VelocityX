...
extension VxTransformExtension on Widget {
  ...
  ///
  Widget flipHorizontal({Key? key}) =>
      Transform(key: key, transform: Matrix4.rotationY(math.pi), child: this);
  ...
  ///
  Widget flipVertical({Key? key}) =>
      Transform(key: key, transform: Matrix4.rotationX(math.pi), child: this);
  ...
  ///
  Widget rotate0({Key? key}) =>
      Transform.rotate(key: key, angle: 0, child: this);
