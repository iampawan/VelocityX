...
extension VxSizedBoxExtension on Widget {
  ...
  Widget wPCT({required BuildContext context, required double widthPCT}) =>
      SizedBox(key: key, width: context.percentWidth * widthPCT, child: this);

  /// [SizedBox] widget with 0% [width] of the [MediaQuery] width
  Widget w0(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 0, child: this);

  /// [SizedBox] widget with 1% [width] of the [MediaQuery] width
  Widget w1(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 1, child: this);

  /// [SizedBox] widget with 2% [width] of the [MediaQuery] width
  Widget w2(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 2, child: this);

  /// [SizedBox] widget with 4% [width] of the [MediaQuery] width
  Widget w4(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 4, child: this);

  /// [SizedBox] widget with 8% [width] of the [MediaQuery] width
  Widget w8(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 8, child: this);

  /// [SizedBox] widget with 10% [width] of the [MediaQuery] width
  Widget w10(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 10, child: this);

  /// [SizedBox] widget with 15% [width] of the [MediaQuery] width
  Widget w15(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 15, child: this);

  /// [SizedBox] widget with 16% [width] of the [MediaQuery] width
  Widget w16(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 16, child: this);

  /// [SizedBox] widget with 20% [width] of the [MediaQuery] width
  Widget w20(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 20, child: this);

  /// [SizedBox] widget with 24% [width] of the [MediaQuery] width
  Widget w24(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 24, child: this);

  /// [SizedBox] widget with 32% [width] of the [MediaQuery] width
  Widget w32(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 32, child: this);

  /// [SizedBox] widget with 40% [width] of the [MediaQuery] width
  Widget w40(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 40, child: this);

  /// [SizedBox] widget with 48% [width] of the [MediaQuery] width
  Widget w48(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 48, child: this);

  /// [SizedBox] widget with 56% [width] of the [MediaQuery] width
  Widget w56(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 56, child: this);

  /// [SizedBox] widget with 60% [width] of the [MediaQuery] width
  Widget w60(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 60, child: this);

  /// [SizedBox] widget with 64% [width] of the [MediaQuery] width
  Widget w64(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 64, child: this);

  /// [SizedBox] widget with half or 50% [width] of the [MediaQuery] width
  Widget wHalf(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 50, child: this);

  /// [SizedBox] widget with one-third or 33.33% [width] of the [MediaQuery] width
  Widget wOneThird(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 33.333333, child: this);

  /// [SizedBox] widget with two-third or 66.67% [width] of the [MediaQuery] width
  Widget wTwoThird(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 66.666667, child: this);

  /// [SizedBox] widget with one-forth or 25% [width] of the [MediaQuery] width
  Widget wOneForth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 25, child: this);

  /// [SizedBox] widget with three-forth or 75% [width] of the [MediaQuery] width
  Widget wThreeForth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 75, child: this);

  /// [SizedBox] widget with four-fifth or 80% [width] of the [MediaQuery] width
  Widget wFourFifth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.percentWidth * 80, child: this);

  /// [SizedBox] widget with full [width] of the [MediaQuery] width
  Widget wFull(BuildContext context, {Key? key}) =>
      SizedBox(key: key, width: context.screenWidth, child: this);
  ...
  Widget h0(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 0, child: this);

  /// [SizedBox] widget with 1% [height] of the [MediaQuery] height
  Widget h1(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 1, child: this);

  /// [SizedBox] widget with 2% [height] of the [MediaQuery] height
  Widget h2(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 2, child: this);

  /// [SizedBox] widget with 4% [height] of the [MediaQuery] height
  Widget h4(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 4, child: this);

  /// [SizedBox] widget with 8% [height] of the [MediaQuery] height
  Widget h8(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 8, child: this);

  /// [SizedBox] widget with 10% [height] of the [MediaQuery] height
  Widget h10(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 10, child: this);

  /// [SizedBox] widget with 15% [height] of the [MediaQuery] height
  Widget h15(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 15, child: this);

  /// [SizedBox] widget with 16% [height] of the [MediaQuery] height
  Widget h16(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 16, child: this);

  /// [SizedBox] widget with 20% [height] of the [MediaQuery] height
  Widget h20(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 20, child: this);

  /// [SizedBox] widget with 24% [height] of the [MediaQuery] height
  Widget h24(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 24, child: this);

  /// [SizedBox] widget with 32% [height] of the [MediaQuery] height
  Widget h32(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 32, child: this);

  /// [SizedBox] widget with 40% [height] of the [MediaQuery] height
  Widget h40(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 40, child: this);

  /// [SizedBox] widget with 48% [height] of the [MediaQuery] height
  Widget h48(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 48, child: this);

  /// [SizedBox] widget with 56% [height] of the [MediaQuery] height
  Widget h56(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 56, child: this);

  /// [SizedBox] widget with 60% [height] of the [MediaQuery] height
  Widget h60(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 60, child: this);

  /// [SizedBox] widget with 64% [height] of the [MediaQuery] height
  Widget h64(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 64, child: this);

  /// [SizedBox] widget with half or 50% [height] of the [MediaQuery] height
  Widget hHalf(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 50, child: this);
  ...
  Widget hOneForth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 25, child: this);

  /// [SizedBox] widget with three-forth or 75% [height] of the [MediaQuery] height
  Widget hThreeForth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 75, child: this);

  /// [SizedBox] widget with four-fifth or 80% [height] of the [MediaQuery] height
  Widget hFourFifth(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.percentHeight * 80, child: this);

  /// [SizedBox] widget with full [height] of the [MediaQuery] height
  Widget hFull(BuildContext context, {Key? key}) =>
      SizedBox(key: key, height: context.screenHeight, child: this);
